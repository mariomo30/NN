...
vect = CountVectorizer(max_features=350, min_df=5, max_df=0.7, stop_words=stopwords.words('english'))
...
# Convertimos los mensajes a números con el modelo de "Bolsa de palabaras"
vect2 = CountVectorizer(max_features=350, min_df=5, max_df=0.7, stop_words=stopwords.words('english'))
X2 = vect2.fit_transform(documents2).toarray()

# Normalizamos los valores para que queden entre 0 y 1
t2 = TfidfTransformer()
X2 = t.fit_transform(X2).toarray()
